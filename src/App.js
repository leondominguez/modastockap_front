  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/gestion-compras" element={<PrivateRoute><GestionCompras /></PrivateRoute>} />
        <Route path="/gestion-ventas" element={<PrivateRoute><GestionVentas /></PrivateRoute>} />
        <Route path="/gestion-inventario" element={<PrivateRoute><GestionInventario /></PrivateRoute>} />
      </Routes>
    </Router>
  );
}
