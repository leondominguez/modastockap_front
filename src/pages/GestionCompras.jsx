      ...
      <div className="gc__content">
        <aside className="gestion-compras__sidebar">
          ...
          <nav className="gc__nav">
            <button className={"gc__nav-btn " + (active === 'catalogo' ? 'is-active' : '')} onClick={() => setActive('catalogo')}>Catálogo de insumos</button>
            <button className={"gc__nav-btn " + (active === 'proveedor' ? 'is-active' : '')} onClick={() => setActive('proveedor')}>Insumos por proveedor</button>
          </nav>
        </aside>
