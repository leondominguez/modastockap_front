      ...
      <div className="gestion-compras__content">
        <aside className="gestion-compras__sidebar">
          ...
          <nav className="gestion-compras__nav">
            ...
            <button className={"gestion-compras__nav-btn btn " + (active === 'insumosProveedor' ? 'is-active' : '')} onClick={() => setActive('insumosProveedor')}>Insumos por proveedor</button>
        ...
        <main className="gestion-compras__main">
          ...
          {active === 'insumosProveedor' && <InsumosProveedor />}
        </main>
      </div>
    </div>
  );
